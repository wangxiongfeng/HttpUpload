    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                Toast.makeText(MainActivity.this,i+"  ff",Toast.LENGTH_LONG).show();
            }
        });
...
//        videoView.setZOrderOnTop(true);
        ...
        // 1    0.0     16876    https://peertime-test.oss-cn-shanghai.aliyuncs.com/P49/Attachment/D16869/VID_20180622_211909.mp4    1
        // 16991    https://peertime-test.oss-cn-shanghai.aliyuncs.com/P49/Attachment/D16984/VID_20180705_104709.mp4    1

        String path = "https://peertime-test.oss-cn-shanghai.aliyuncs.com/P49/Attachment/D16984/VID_20180705_104709.mp4 ";
...
//        }
        ...
        int time = (newProgress / 100) * 25000;
